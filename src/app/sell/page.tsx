      ...
      <section className="card relative mt-6 overflow-hidden rounded-[2rem] p-8 sm:p-12">
        ...
        <div className="relative max-w-2xl">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Link href="/register" className="pill-lime inline-flex items-center gap-3 rounded-full py-3.5 pl-6 pr-3.5 text-[15px] font-semibold">
              Start selling
              <span className="btn-ink grid h-8 w-8 place-items-center rounded-full">
                <ArrowUpRight className="h-4 w-4" />
              </span>
            </Link>
            <Link href="/about" className="rounded-full border border-hairline px-6 py-3.5 text-[15px] font-medium text-ink transition-colors hover:bg-surface-2">
              How it works
            </Link>
          </div>
        </div>
